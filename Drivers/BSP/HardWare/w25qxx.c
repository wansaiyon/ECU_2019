...
/*      私有函数声明              	                                              */
/**********************************************************************************/
static void	vBSP_W25Qx_Reset(void);
static uint8_t ucBSP_W25Qx_GetStatus(void);
...
uint8_t ucBSP_W25Qx_WriteEnable(void)
{
	...
	while(ucBSP_W25Qx_GetStatus() == W25Qx_BUSY);
	{
